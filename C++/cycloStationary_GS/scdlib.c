...
void mlxDfsm_pace(int nlhs, mxArray *plhs[], int nrhs, mxArray *prhs[])
{
    mclFeval(_mcr_inst, "dfsm_pace", nlhs, plhs, nrhs, prhs);
}

void mlfPlotscd()
{
    mclMlfFeval(_mcr_inst, "plotscd", 0, 0, 0);
}

void mlfDfsm_pace(int nargout, mxArray** S, mxArray** f, mxArray** alfa
                  , mxArray* data, mxArray* fs, mxArray* N, mxArray* L)
{
    mclMlfFeval(_mcr_inst, "dfsm_pace", nargout,
                3, 4, S, f, alfa, data, fs, N, L);
}
