function  [filterFn, islDB, snrLoss condA] = optimalSidelobeSuppression(s, codeLength, weightingType, ...
										filterLength, figureNumber)
%
% function  [filterFn isl snrLoss] =
% optimalSidelobeSuppression(s, codeLength, weightingType, filterLength, figureNumber)
%
...
% Input variables:
% ----------------
%  s:				The input complex code vector
...
%
lambda				= generateLambda(s, codeLength, filterLength);
%
